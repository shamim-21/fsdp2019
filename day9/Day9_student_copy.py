...
conn = mysql.connector.connect(user='shamim_user', password='shamim21',
                              host='db4free.net', database = 'shamim_db')
#, database = 'forsk_test'
...
client = pymongo.MongoClient("mongodb://shamim:soma%5F21@cluster0-shard-00-00-t5a4a.mongodb.net:27017,cluster0-shard-00-01-t5a4a.mongodb.net:27017,cluster0-shard-00-02-t5a4a.mongodb.net:27017/test?ssl=true&replicaSet=Cluster0-shard-0&authSource=admin&retryWrites=true")
mydb = client.shamim_db
